...
def test_get_user_by_email(sut, users, email, expected, print_message, capsys):
    controller, mocked_controller = sut
...
def test_invalid_email_raises(sut):
    controller, _ = sut
